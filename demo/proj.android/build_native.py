...
def copy_resources(app_android_root):
    ...
    shutil.copy(os.path.join(app_android_root, "../Document/main.js"), assets_dir)
    shutil.copy(os.path.join(app_android_root, "../Document/project.json"), assets_dir)

    resources_dir = os.path.join(app_android_root, "../Document/res")
    copy_files(resources_dir, assets_res_dir)

    resources_dir = os.path.join(app_android_root, "../Document/src")
    copy_files(resources_dir, assets_scripts_dir)

    resources_dir = os.path.join(app_android_root, "../../cocos2d-js-v3.6/frameworks/js-bindings/bindings/script")
...
def build(targets,ndk_build_param,build_mode):
    ...
    cocos_root = os.path.join(project_root, "..", "..", "cocos2d-js-v3.6", "frameworks/js-bindings/cocos2d-x")
