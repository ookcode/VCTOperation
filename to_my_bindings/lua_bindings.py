...
def main():
    ...
    try:
        ...
        tolua_root = '%s/tools/to_my_bindings' % project_root
        output_dir = '%s/tools/to_my_bindings/lua-bindings' % project_root

        cmd_args = {'channel.ini': ('VCTChannel', 'lua_bindings_channel')}
        target = 'lua'
