...
def main():
    ...
    try:
        ...
        tojs_root = '%s/tools/to_my_bindings' % project_root
        output_dir = '%s/tools/to_my_bindings/js-bindings' % project_root

        cmd_args = {'channel.ini': ('VCTChannel', 'js_bindings_channel')}
        target = 'spidermonkey'
